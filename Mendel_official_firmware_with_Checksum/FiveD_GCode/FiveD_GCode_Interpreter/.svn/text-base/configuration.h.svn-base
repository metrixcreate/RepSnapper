...
#define E_STEPS_PER_MM   2 //0.706   // NEMA 17 extruder 5mm diameter drive - empirically adjusted
...
#define SLOW_XY_FEEDRATE 400.0 // Speed from which to start accelerating
#define SLOW_Z_FEEDRATE 25
